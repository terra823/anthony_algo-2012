...
void particle::draw(){
	...
	ofRotate(-sin(360), 70, 60, 70);
	ofNoFill();
	ofSetColor(255, 255, 255, 60);
	ofCircle(pos.x,pos.y, 30*cos(ofGetElapsedTimef()*.2));
	
	
	ofNoFill();
	ofSetColor(255, 255, 255, 60);
	ofCircle(pos.x,pos.y, 30*cos(ofGetElapsedTimef()*.3));
	
	
	ofFill();
	ofSetColor(213, 214, 2, 30);
	ofCircle(pos.x,pos.y, 35*cos(ofGetElapsedTimef()*.5));
